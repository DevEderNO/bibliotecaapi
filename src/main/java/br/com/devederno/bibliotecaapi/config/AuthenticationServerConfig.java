package br.com.devederno.bibliotecaapi.config;
...
import br.com.devederno.bibliotecaapi.token.CustomTokenEnhancer;
...
public class AuthenticationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory().withClient("apiBibliotecaClient").secret(secretKey).scopes("write", "read")
				.authorizedGrantTypes("password", "refresh_token").accessTokenValiditySeconds(6000)
